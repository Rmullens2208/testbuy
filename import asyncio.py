...
# Access the quote value to get the ETH price in USD
    ...
    print("Finished updating unique_token_lines.txt")
      ...
      # send the summary to telegr
    bot_token = "6008723041:AAF2V8KR16ydxyZWoUG5a_bX22Yn63OgdBw"
    bot = telegram.Bot(token=bot_token)
    chart_link = 'https://www.dextools.io/app/en/ether/pair-explorer/0xa2376a5304cfcd238f52db5677cba3e0559f7f09'
    bot_name = '      🤖 WALLY BOT 🤖'
    message = f'{bot_name}\n\n'
    message += f'💵  Total ETH Buys: {total_eth_buys:.8f}\n'
    message += f'💰  Total ETH Sells: {total_eth_sells:.8f}\n'
    message += f'✅  Total Wins: {win_count}\n'
    message += f'🚫  Total Losses: {loss_count}\n\n'
    message += f'💯  Win Percentage: {win_percentage:.2f}%\n\n'
    message += f'🪙  Tokens Still Holding Buy Value: {holding_tokens_value:.8f}\n'
    message += f'💵  Market Price Of tokens holding : {total_token_value_in_eth}\n'
    message += f'@WallyBot_Group'
